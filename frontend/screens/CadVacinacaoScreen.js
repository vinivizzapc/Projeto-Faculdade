        ...
        <View style={{flex:1,}}>
          <View style={{paddingLeft:10, alignItems:'center', margin:10}}>
            ...
            <Text style={[styles.text_footer,{marginTop:15, marginLeft:10}]}>Local</Text>
              ...
              <View style={{backgroundColor:'#cfd8dc', height:40, width:110, justifyContent:'center', alignItems:'center', borderRadius:8, borderColor:'black', borderWidth:2,marginLeft:10, marginTop:10  }}>
